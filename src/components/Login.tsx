    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 via-slate-900 to-black px-4">
            ...
            >
                ...
                <h2 className="text-3xl font-bold text-white text-center mb-1 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Welcome back!</h2>
                <p className="text-center text-gray-400 mb-4 text-base">Sign in to continue your abacus journey</p>
