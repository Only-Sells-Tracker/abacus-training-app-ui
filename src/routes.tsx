...
export function AppRoutes({ tournaments, onSelectTournament, onCustomPractice, selectedTournament, handleBackToDashboard }: any) {
  return (
    <Routes>
      ...
      <Route path="/settings" element={<SettingsPage onSignOut={handleBackToDashboard} />} />
